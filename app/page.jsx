...
import Property1Src from "../public/property-card-1.jpg";
import Property2Src from "../public/property-card-2.jpg";
import Property3Src from "../public/property-card-3.jpg";
  ...
  return (
    <>
      ...
      <section className="py-12 space-y-8 bg-gray-100 md:space-y-0">
        ...
        <div className="container grid max-w-6xl gap-10 px-12 mx-auto sm:grid-cols-2 sm:px-8 md:grid-cols-3 xl:px-0 md:py-16 md:gap-6">
          <CardProperty
            imgSrc={Property1Src}
